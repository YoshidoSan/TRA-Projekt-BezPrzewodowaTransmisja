...
# Wczytaj DataFrame
df1 = pd.read_csv('jammer5000/Receiver_received.csv')
df2 = pd.read_csv('jammer5000/Sender_received.csv')
df3 = pd.read_csv('Jammer_received.csv')
